...
void main() => runApp(MyAddCulinaria());

class MyAddCulinaria extends StatelessWidget {
...
class AddCulinaria extends StatefulWidget {
  @override
  _AddCulinariaState createState() => _AddCulinariaState();
}

class _AddCulinariaState extends State<AddCulinaria> {
  ...
  _cadastrarLoc( AddPaginas loc ){
    ...
    db.collection("markersAddRest").add(
        {
          "nome" : loc.nome,
          "local" : loc.local,
          "end" : loc.end,
          ...
          "Rodizio" :  checkBoxValue1,
          "A la Carte" : checkBoxValue2,
          "Comer no Local" : checkBoxValue3,
          "Delivery" : checkBoxValue4,
                      ...
                      Padding(padding: EdgeInsets.only(top: 50, bottom: 30, right: 35),
                        child: Column(
                          ...
                          children: [
                            ...
                            textFieldd(_controllerObs, FontAwesomeIcons.edit, "Observação: ", "Alguma observação sobre o Restaurante?"),
                              ...
                              child: FlatButton(
                                onPressed: () {
                                  if(_controllerLocal.text== '' || _controllerNome.text=='' || _controllerEnd.text==''){
                                    ...
                                    _onSuccess();
                                    _validarCampos();
                                    model.NovaLocalizacao(context, MyAddCulinaria());
                                    }
                                },
