...
void main() => runApp(MyAddTurismo());

class MyAddTurismo extends StatelessWidget {
...
class AddTurismo extends StatefulWidget {
  @override
  _AddTurismoState createState() => _AddTurismoState();
}

class _AddTurismoState extends State<AddTurismo> {
  ...
  _cadastrarLoc(AddPaginas loc) {
    ...
    db.collection("markersAddTur").add({
      "nome": loc.nome,
      "local": loc.local,
      "end": loc.end,
      "obs": loc.obs,
      ...
      "Pg para visitas": checkBoxValue1,
      "Amb. Aberto": checkBoxValue2,
      "Amb. Fechado": checkBoxValue3,
      "Turismo Local": checkBoxValue4,
      "Turismo Religioso": checkBoxValue5,
      "Ecoturismo": checkBoxValue6,
                          ...
                          children: [
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Text(
                                  "Necessita de Pagamento para visitas",
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Icon(FontAwesomeIcons.leaf, color: Colors.blue),
                              ],
                            ),
                            Row(
                              children: <Widget>[
                            ...
                            textFieldd(_controllerObs, FontAwesomeIcons.edit, "Observação: ", "Alguma observação sobre o ambiente?"),
                              ...
                              child: FlatButton(
                                onPressed: () {
                                  if (_controllerLocal.text == '' ||
                                    ...
                                    _onSuccess();
                                    _validarCampos();
                                    model.NovaLocalizacao(context, MyMapaTurismo());
                                  }
                                },
