...
void main() => runApp(MyAddBanheiro());

class MyAddBanheiro extends StatelessWidget {
...
class AddBanheiro extends StatefulWidget {
  @override
  _AddBanheiroState createState() => _AddBanheiroState();
}
...
class _AddBanheiroState extends State<AddBanheiro> {
  ...
  _cadastrarLoc(AddPaginas loc) {
    ...
    db.collection("markersAddBanh").add({
      "nome": loc.nome,
      "local": loc.local,
      "end": loc.end,
      "obs": loc.obs,
      ...
      "Banh. Pago?": checkBoxValue1,
      "Banheiro PCD": checkBoxValue2,
      "Fraldário": checkBoxValue3,
                          ...
                          children: [
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Text(
                                  "Necessita de Pagamento para usar",
                            ...
                            textFieldd(_controllerObs, FontAwesomeIcons.edit, "Observação: ", "Alguma observação sobre o uso do banheiro?"),
                              ...
                              child: FlatButton(
                                onPressed: () {
                                  if (_controllerLocal.text == '' ||
                                    ...
                                    _onSuccess();
                                    _validarCampos();
                                    model.NovaLocalizacao(context, MyMapaBanheiro());
                                  }
                                },
