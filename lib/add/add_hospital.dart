...
class _AddHospitalState extends State<AddHospital> {
  ...
  _cadastrarLoc(AddPaginas loc) {
    ...
    db.collection(Global.firebaseAddHospital).add({
      "nome": loc.nome,
      "local": loc.local,
      "end": loc.end,
      "lat": latDevice,
                      ...
                      children: [
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Text(
                              'Selecione os horários de visita:',
                              style: TextStyle(
                                  color: Colors.blue,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 14),
                        ...
                        Row(
                          children: <Widget>[
                            Text(
                                "Qual sua nota de 1 á 5, referente ao atendimento?",
                                style: TextStyle(
                                    color: Colors.blue,
                                    fontSize: 14,
                                    fontWeight: FontWeight.bold)),
                        ...
                        textFieldd(
                            ...
                            "Observação: ",
                            "Alguma observação sobre o uso do Hospital?"),
                        Padding(
