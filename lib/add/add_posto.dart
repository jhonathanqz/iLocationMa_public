...
void main() => runApp(MyAddPosto());

class MyAddPosto extends StatelessWidget {
...
class _AddPostoState extends State<AddPosto> {
  ...
  _cadastrarLoc(AddPaginas loc) {
    ...
    db.collection("markersAddPosto").add({
      ...
      "Possui Conveniência": checkBoxValue1,
      "Posto 24h": checkBoxValue2,
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Text('Adicionar Posto de Combustível',
                            style: TextStyle(
                                fontFamily: 'Montserrat',
                                color: Colors.white,
                                fontSize: 20.0))
                              ...
                              child: FlatButton(
                                onPressed: () {
                                  if (_controllerLocal.text == '' ||
                                    ...
                                    _onSuccess();
                                    _validarCampos();
                                    model.NovaLocalizacao(context, MyMapaPosto());
