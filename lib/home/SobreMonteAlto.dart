          ...
          Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                Padding(padding: EdgeInsets.only(top: 10,bottom: 30,left: 0),
                  child: Column(
                    children: <Widget>[
                      FadeAnimation(1, Container(
                          ...
                          child: Padding(
                            ...
                            child: Text("       Monte Alto é uma simpática cidade do interior de São Paulo, com aproximadamente 50 mil habitantes, situada a 350Km da capital, fundada a 139 anos por Porfírio Luís de Alcântara Pimentel, farmacêutico e cirurgião do imperador Dom Pedro II."
                                "\n\n       De Onírica imagem a cidade real, surgiu então a próspera ""Cidade Sonho"", inicialmente denominada Bom Jesus de Pirapora das Três Divisas de Monte Alto, inspirado em seu padroeiro o Sr. Bom Jesus."
