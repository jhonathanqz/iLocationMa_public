...
import 'package:ilocationma/modelsfunc/add_model.dart';
...
class _HomePrincipalState extends State<HomePrincipal> {
                    ...
                    Padding(
                        ...
                        child: Container(
                            ...
                            child: ListView(children: [
                              _buildFoodItem('assets/hospital1.png', 'Hospital', SplashHosp()),
                              SizedBox(height: 15,),
                              _buildFoodItem('assets/farmacia1.png', 'Farmácia', SplashFarm()),
                              SizedBox(height: 15,),
                              _buildFoodItem('assets/banco3.png', 'Bancos',  SplashBancos()),
                              SizedBox(height: 15,),
                              _buildFoodItem('assets/culinaria1.png', 'Alimentação', SplashCulinaria()),
                              SizedBox(height: 15,),
                              _buildFoodItem('assets/turismo3.png', 'Turismo',  SplashTurismo()),
                              SizedBox(height: 15,),
                              _buildFoodItem('assets/posto1.png', 'Posto de Combustível',  SplashPosto()),
                              SizedBox(height: 15,),
                              _buildFoodItem('assets/banheiro1.png', 'Banheiros', SplashBan()),
                              SizedBox(height: 15,),
                              Padding(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    setState(() {
                                      model.verificaLoginMapa(context, MyHomeQR());
                                    });
                                  },
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              ...
                              SizedBox(height: 15,),
                              _buildFoodItem('assets/mont3.png', 'Sobre a Cidade',  MySobreCidade()),
                              SizedBox(height: 15,),
                            ]))),
                    SizedBox(height: 15,),
                    Row(
  ...
  void _onSuccess(){
    _scaffoldKey.currentState.showSnackBar(
      SnackBar(content: Text("Você já está logado!", style: TextStyle(
