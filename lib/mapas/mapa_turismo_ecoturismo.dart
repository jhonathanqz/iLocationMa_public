...
import 'package:ilocationma/mapas/homemap/cardmapTurEco.dart';
...
class MapaTurismoEcoturismoState extends State<MapaTurismoEcoturismo> {
  ...
  var snapshots = FirebaseFirestore.instance.collection(Global.firebaseTurEco).snapshots();
  ...
  Future<void> _onMapCreated(GoogleMapController controller) async {
    ...
    QuerySnapshot resultado =
        await db.collection(Global.firebaseTurEco).get();
          ...
          leading: IconButton(
            ...
            onPressed: () {
              Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => HomeMapTur()));
            },
          ),
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => CardMapTurEco()));
                },
                child: Container(
                  child: new FittedBox(
                    child: Material(
