...
class CardMapPosto extends StatelessWidget {
  var snapshots =
      FirebaseFirestore.instance.collection(Global.firebasePosto).snapshots();
        ...
        builder: (
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int i) {
              ...
              var precoEtanol = item['precoEtanol'] ?? 'Sem registros';
              var precoGasolina = item['precoGasolina'] ?? 'Sem registros';
              var precoDiesel = item['precoDiesel'] ?? 'Sem registros';
